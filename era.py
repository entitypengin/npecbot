...
def get_time() -> str:
    ce_now = datetime.datetime.now()
    shifted = ce_now + datetime.timedelta(hours=9)
    ordin = (shifted.date() - datetime.date(year=shifted.year, month=1, day=1)).days
    calendar = [
        ...
        "02-20", "02-21", "02-22", "02-23", "02-24", "02-25", "02-26", "02-27", "02-28", "02-29", "02-30",
        ...
        "05-20", "05-21", "05-22", "05-23", "05-24", "05-25", "05-26", "05-27", "05-28", "05-29", "05-30",
        *["V" for _ in range(1) if shifted.year % 4 == 0 and (shifted.year % 100 != 0 or shifted.year % 400 == 0)],
        ...
        "08-20", "08-21", "08-22", "08-23", "08-24", "08-25", "08-26", "08-27", "08-28", "08-29", "08-30",
...
`VE {shifted.year}-{calendar[ordin]} {shifted.time()}`
